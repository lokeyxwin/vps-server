...
- 数据查询工具: get_available_proxy_nodes / get_registered_ips / get_registered_vps
...
from tools.get_registered_vps import TOOL as _get_registered_vps_tool
from tools.get_registered_vps import handler as _get_registered_vps_handler
...
ALL_TOOLS = [
    ...
    (_get_registered_vps_tool, _get_registered_vps_handler),
    # ---------- 写入修改工具 (admin) ----------
