...
- `test/ssh_worker/spec.md` **v4** §2 入口契约（入参 + 返回形状）
...
```
test/ssh_worker/TC-05_main_flow.py
```
...
### TC-05 `test/ssh_worker/TC-05_main_flow.py`
...
测试 9/9 全过：
- `test/ssh_worker/TC-05_main_flow.py` 新建
...
**顺手做的事**:`test/README.md` 新增"测试隔离 session_scope patch 套路"
